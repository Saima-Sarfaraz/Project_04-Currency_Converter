...
let apiLink =
    " https://v6.exchangerate-api.com/v6/3079033c4c53a906d9991823/latest/PKR";
...
// conversion rate 
let cnv =
    `https://v6.exchangerate-api.com/v6/3079033c4c53a906d9991823/pair/${firstCountry.name}/${secondCountry.name}`;
